	  ...
	  _createClass(Main, [{
	    ...
	    value: function render() {
	      ...
	      var children = _react2.default.Children.map(this.props.children, function (child) {
	        var props = {
	          shouldSearch: _this2.state.shouldSearch,
	          unsetShouldSearch: _this2.unsetShouldSearch.bind(_this2)
	        };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _QueryLabelList = __webpack_require__(237);

	var _QueryLabelList2 = _interopRequireDefault(_QueryLabelList);

	var _OrgCategory = __webpack_require__(238);
	  ...
	  _createClass(SearchBar, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'general-keyword box shadow' },
	            _react2.default.createElement(
	              'div',
	              { className: 'header' },
	              _react2.default.createElement('i', { className: 'fa fa-search' })
	            ),
	            _react2.default.createElement(_QueryLabelList2.default, {
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement('input', { type: 'text', name: 'keyword', placeholder: '검색어를 입력하세요.',
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement('input', { type: 'radio', id: 'cat-example',
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  'div',
	                  { className: 'radio-button' },
	                  _react2.default.createElement('input', { type: 'radio', id: 'cat-organ', name: 'category', value: 'organ',
	                    onClick: this.handleCategoryClick.bind(this)
	                  }),
	                  _react2.default.createElement(
	                    'label',
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(_OrgCategory2.default, {
	                query: this.state.query,
	    ...
	    value: function componentDidMount() {
	      ...
	      _axios2.default.get(url).then(function (_ref2) {
	        ...
	        var self = _this3;
	        var orgItems = [];
	        labels = (0, _utils.storeLabels)(_this3.state.labels, data[0].items[0]);
	        data[1].items[0].items.forEach(function (item) {
	          labels = (0, _utils.storeLabels)(self.state.labels, item);
	          orgItems.push(item);
	        });
	        labels = (0, _utils.storeLabels)(_this3.state.labels, data[1].items[1]);
	        orgItems.push(data[1].items[1]);
	        labels = (0, _utils.storeLabels)(_this3.state.labels, data[1].items[2]);
	        orgItems.push(data[1].items[2]);
	        labels = (0, _utils.storeLabels)(_this3.state.labels, data[1].items[3]);
	        orgItems.push(data[1].items[3]);
	        labels = (0, _utils.storeLabels)(_this3.state.labels, data[1].items[4]);
	        orgItems.push(data[1].items[4]);
	        labels = (0, _utils.storeLabels)(_this3.state.labels, data[1].items[5]);
	        orgItems.push(data[1].items[5]);

	        var _parseArticles = parseArticles(data[0].items[0]);

	        var chapters = _parseArticles.chapters;
	        var chapterArticles = _parseArticles.chapterArticles;
	        ...
	        var queries = _this3.props.location.query;
	        var query = {};
	        for (var field in queries) {
	          if (field === 'q') {
	            ...
	            var values = valuesAsInt.map(function (value) {
	              return '' + value;
	            });
	            query[field] = values;
	          }
	...
	function parseArticles(optBlock) {
	  ...
	  optBlock.options.forEach(function (option) {
	    if (option.depth === 0) {
	      chapters.push(option);
	    } else {
	      var chapter = option.parent;
...
/***/ function(module, exports) {
	...
	function getLabel(labels, field, value) {
	  return labels && labels[field] && labels[field][value] || '';
	}

	// query ex : { a11: [1, 3, 5], o2: [2, 3, 6] }
	function inQuery(query, field, value) {
	  return query && Array.isArray(query[field]) && query[field].indexOf(value) !== -1;
	}

	function toggleInQuery(query, field, value) {
	...
	function changeInQuery(query, field, value) {
	  if (!Array.isArray(query[field])) {
	    query[field] = [];
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QueryLabelList = function QueryLabelList(_ref) {
	  var query = _ref.query;
	  ...
	  var _loop = function _loop(field) {
	    var values = query[field];
	    values.forEach(function (value) {
	      queryLabels.push({
	        field: field,
	        value: value,
	        label: (0, _utils.getLabel)(labels, field, value)
	      });
	    });
	  };
	  ...
	  var rows = queryLabels.map(function (_ref2) {
	    ...
	    return _react2.default.createElement(
	      'div',
	      { key: field + '-' + value, className: 'key-list gen-key' },
	      _react2.default.createElement('i', { className: 'header fa fa-key' }),
	      label,
	      _react2.default.createElement('i', { className: 'close fa fa-times',
	        onClick: function onClick() {
	          _onClick(field, value);
	        }
	      })
	    );
	  });
	...
	exports.default = QueryLabelList;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OrgCategory = function OrgCategory(_ref) {
	  var query = _ref.query;
	  var catetories = _ref.catetories;
	  var onCheckboxClick = _ref.onCheckboxClick;
	  var onSelectSelect = _ref.onSelectSelect;
	  var onSelectClick = _ref.onSelectClick;
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      'div',
	      { className: 'width33' },
	      _react2.default.createElement(_SelectOptions2.default, _extends({}, catetories[0], {
	        query: query, field: catetories[0].key,
	        oClick: onSelectSelect,
	        onSClick: onSelectClick
	      })),
	      _react2.default.createElement(_SelectOptions2.default, _extends({}, catetories[1], {
	        query: query, field: catetories[1].key,
	        oClick: onSelectSelect,
	        onSClick: onSelectClick
	      })),
	      _react2.default.createElement(_SelectOptions2.default, _extends({}, catetories[2], {
	        query: query, field: catetories[2].key,
	        oClick: onSelectSelect,
	        onSClick: onSelectClick
	      })),
	      _react2.default.createElement(_SelectOptions2.default, _extends({}, catetories[3], {
	        query: query, field: catetories[3].key,
	        oClick: onSelectSelect,
	        onSClick: onSelectClick
	      })),
	      _react2.default.createElement(_SelectOptions2.default, _extends({}, catetories[4], {
	        query: query, field: catetories[4].key,
	        oClick: onSelectSelect,
	        onSClick: onSelectClick
	      })),
	      _react2.default.createElement(_CheckboxOptions2.default, _extends({}, catetories[8], {
	    ...
	    _react2.default.createElement(
	      'div',
	      { className: 'width33' },
	      _react2.default.createElement(_CheckboxOptions2.default, _extends({}, catetories[6], {
	        query: query, field: catetories[6].key,
	        onClick: onCheckboxClick,
	        classname: 'column1'
	      })),
	      _react2.default.createElement(_CheckboxOptions2.default, _extends({}, catetories[9], {
	    ...
	    _react2.default.createElement(
	      'div',
	      { className: 'width33' },
	      _react2.default.createElement(_CheckboxOptions2.default, _extends({}, catetories[7], {
	        query: query, field: catetories[7].key,
	        onClick: onCheckboxClick,
	        classname: 'column2'
	      })),
	      _react2.default.createElement(_CheckboxOptions2.default, _extends({}, catetories[10], {
	...
	var CheckboxOptions = function CheckboxOptions(_ref) {
	  ...
	  var rows = options.map(function (_ref2) {
	    ...
	    return _react2.default.createElement(
	      'li',
	      { key: id, className: 'checkbox-wrap' },
	      _react2.default.createElement('input', { type: 'checkbox', id: id, checked: checked,
	        onChange: function onChange() {
	          onClick(field, value);
	        }
	      }),
	  ...
	  return _react2.default.createElement(
	    'div',
	    { className: 'checkbox-options top-dotted' },
	    _react2.default.createElement(
	      'p',
	      null,
	      name
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ArticleCategory = function ArticleCategory(_ref) {
	  ...
	  var articleRows = articles.map(function (_ref3) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ArticleList = __webpack_require__(247);
	...
	var Search = function (_Component) {
	  ...
	  _createClass(Search, [{
	    key: 'render',
	    value: function render() {
	      var cname = this.state.standards.length > 0 ? 'intermediate-result' : 'intermediate-result full';
	      return _react2.default.createElement(
	        'div',
	    ...
	    value: function doSearch() {
	      ...
	      _axios2.default.get(url).then(function (_ref) {
	        ...
	        _this2.props.unsetShouldSearch();
	      });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StandardList = function StandardList(_ref) {
	  var standards = _ref.standards;

	  var items = standards.map(makeItem);
	  items.length = 5;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ArticleItem = __webpack_require__(248);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Orgv = __webpack_require__(250);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _OrgAgreement = __webpack_require__(251);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Orgs = function (_Component) {
	  _inherits(Orgs, _Component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Org = function (_Component) {
	  _inherits(Org, _Component);

	  function Org() {
	    _classCallCheck(this, Org);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Org).call(this));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Standard = function (_Component) {
	...
	var Articles = function (_Component) {
	  ...
	  _createClass(Articles, [{
	    ...
	    value: function render() {
	      ...
	      var chapters = this.state.chapters.map(function (item, index) {
	        var id = 'chapter-' + item.value;
	        return _react2.default.createElement(
	          'li',
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'radio-button' },
	            _react2.default.createElement('input', { type: 'radio', name: 'chapter', id: id, value: item.value,
	              onClick: _this2.handleChapterClick.bind(_this2)
	            }),
	            _react2.default.createElement(
	              'label',
	              { htmlFor: id },
	      ...
	      var articles = this.state.articles.map(function (item, index) {
	        var id = 'article-' + item.value;
	        return _react2.default.createElement(
	          'li',
	          { key: index, className: 'checkbox-wrap' },
	          _react2.default.createElement('input', { type: 'checkbox', name: 'article', id: id, value: item.value,
	            onClick: _this2.handleArticleClick.bind(_this2)
	          }),
	          _react2.default.createElement(
	            'label',
	            { className: 'checkbox', htmlFor: id },
	    ...
	    key: 'parseArticles',
	    value: function parseArticles(sopt) {
	      var chapters = [];
	      var chapterArticles = {};

	      sopt.options.forEach(function (option) {
	        if (option.depth === 0) {
	          chapters.push(option);
	        } else {
	          var chapter = option.parent;
	    ...
	    key: 'handleChapterClick',
	    value: function handleChapterClick(e) {
	      var value = e.target.value;
	      this.setState({
	        articles: this.state.chapterArticles[value] || []
	      });
